...
O projeto COIN-OR, do inglês \textit{COmputational INfrastructure for Operations Research},
 ...
 método de pontos interiores com filtro apresentado por \citeauthor{article:Ipopt}. Sua licença é a EPL que permite uso gratuito e acesso ao código. Mais detalhes sobre está biblioteca podem ser obtidos na pagina do seu repositório no GitHub  \url{https://github.com/coin-or/Ipopt}.
