...
composta por varais células ligadas entre se. Uma célula de bateria é basicamente composta por dois elétrodos-- positivo e
...
\begin{figure}[h]
	...
	\end{tikzpicture}
	\caption*{\footnotesize Fonte: Adaptado de \citeauthor{book:Numerical_Optimal_Control}.}
\end{figure}
...
O optimizador  utilizado neste trabalho é o IPOPT, configuração pré-definida da biblioteca FALCON.m. Mais informações sobre a utilização do FALCON.m pode ser consultadas em seu manual \citeauthor{manual:Falcon}.
\begin{figure}[h]
	\centering
...
O projeto COIN-OR, do inglês \textit{COmputational INfrastructure for Operations Research},
 ...
 método de pontos interiores com filtro apresentado por \citeauthor{article:Ipopt}. Sua licença é a EPL que permite uso gratuito e acesso ao código. Mais detalhes sobre está biblioteca podem ser obtidos na pagina do seu repositório no GitHub\textsuperscript{\textregistered} \url{https://github.com/coin-or/Ipopt}.
